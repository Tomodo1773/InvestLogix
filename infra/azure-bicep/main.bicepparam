...
param appSettings = {
  ...
  JQUANTS_MAIL_ADDRESS: readEnvironmentVariable('JQUANTS_MAIL_ADDRESS', 'your-email@example.com')
  JQUANTS_PASSWORD: readEnvironmentVariable('JQUANTS_PASSWORD', 'your-password')
