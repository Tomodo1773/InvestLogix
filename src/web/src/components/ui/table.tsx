  ...
  return (
    <td
      ...
      className={cn(
        ...
        "first:sticky first:left-0 first:z-10 first:bg-card first:group-hover:bg-muted first:max-w-[120px] first:overflow-hidden first:text-ellipsis md:first:max-w-none md:first:overflow-visible",
        className
      )}
      {...props}
    />
